//**************************** 
// Game Veriables(Initial Values For Game)
//**************************** 
...
const lightPieces = [
    {
        position: 'A-8',
        icon: '../assets/images/chess-icons/light/chess-rook-light.svg',
        points: 5,
        piece: 'rook'
    },
    {
        position: 'B-8',
        icon: '../assets/images/chess-icons/light/chess-knight-light.svg',
        points: 3,
        piece: 'knight'
    },
    {
        position: 'C-8',
        icon: '../assets/images/chess-icons/light/chess-bishop-light.svg',
        points: 3,
        piece: 'bishop'
    },
    {
        position: 'D-8',
        icon: '../assets/images/chess-icons/light/chess-queen-light.svg',
        points: 9,
        piece: 'queen'
    },
    {
        position: 'E-8',
        icon: '../assets/images/chess-icons/light/chess-king-light.svg',
        points: 10,
        piece: 'king'
    },
    {
    ...
    {
        position: 'A-7',
        icon: '../assets/images/chess-icons/light/chess-pawn-light.svg',
        points: 5,
        piece: 'pawn'
    },
    {
...
const blackPieces = [
    {
        position: 'A-1',
        icon: '../assets/images/chess-icons/black/chess-rook-black.svg',
        points: 5,
        piece: 'rook'
    },
    {
        position: 'B-1',
        icon: '../assets/images/chess-icons/black/chess-knight-black.svg',
        points: 3,
        piece: 'knight'
    },
    {
        position: 'C-1',
        icon: '../assets/images/chess-icons/black/chess-bishop-black.svg',
        points: 3,
        piece: 'bishop'
    },
    {
        position: 'D-1',
        icon: '../assets/images/chess-icons/black/chess-queen-black.svg',
        points: 9,
        piece: 'queen'
    },
    {
        position: 'E-1',
        icon: '../assets/images/chess-icons/black/chess-king-black.svg',
        points: 10,
        piece: 'king'
    },
    {
    ...
    {
        position: 'A-2',
        icon: '../assets/images/chess-icons/black/chess-pawn-black.svg',
        points: 5,
        piece: 'pawn'
    },
    {
...
const getPawnPossibleMoves = (xAxis, yAxis, xAxisIndex, yAxisIndex) => {
    let possibleMoves = [];

    let forwardMoves = 1;

    let yAxesIndexForCapture = null;
    ...
    if(player === 'light'){
        ...
        yAxesIndexForCapture = yAxisIndex - 1;
        canMoveForward = yAxesIndex > 0;

        for(let y = yAxisIndex - 1; y >= yAxesIndex - forwardMoves; y--){
            if(y < 0){
                break;
            }
    ...
    if(canMoveForward){
       if(xAxisIndex > 0){
           let pieceToCaptureLeft = document.getElementById(`${xAxis[xAxisIndex - 1]}-${yAxis[yAxesIndexForCapture]}`);
       ...
       if(xAxisIndex < xAxis.length - 1){
         let pieceToCaptureRight = document.getElementById(`${xAxis[xAxisIndex + 1]}-${yAxis[yAxesIndexForCapture]}`);
    ...
    if(Object.keys(pawnsToPerformElPassant).length > 0){
        if(xAxisIndex -1 >= 0){
            ...
            )
            {
                ...
                let boxForElPassant = document.getElementById(`${xAxis[yAxis[yAxisIndexForCapture]]}-${xAxisPos}`);
    ...
    for(let i=0; i < myPieces.length; i++){
        ...
        switch(myPiece.dataset.piece){
            ...
            case 'queen':
                ...
                break;
            case 'king':
                piecePossibleMoves = getKingPossibleMoves(myPieceXPos, myPieceYPos, myPieceXAxisIndex, myPieceYAxisIndex);
                break;
            default:
                    break;
        }
